...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Characters of <?= $name ?></title>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-pills" style="margin-top: 8px">
                        <li class="active"><a href="player2.php?name=<?= t($name) ?>">Characters (<?= t($charactercount) ?>)</a></li>
                        ...
                        <table id="d" class="table table-striped tablesorter">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><?php for($i = 0; $i < 4; $i++) { ?><span class="item" data-item="<?= str_replace(' ', '', explode(",", $rupee['items'])[$i]) ?>"></span><?php }if ($rupee['hasBackpack'] == 1) { ?><span class="item" data-item="3180" data-original-title="" title=""></span><?php } ?></td>
                                    <td>
