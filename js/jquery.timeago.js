!function (t) {
    ...
    t.extend(t.timeago, {
        settings: {
            ...
            var o = Math.abs(e) / 1e3, s = o / 60, u = s / 60, m = u / 24, d = m / 365, f = 45 > o && r(a.seconds, Math.round(o)) || 90 > o && r(a.minute, 1) || 45 > s && r(a.minutes, Math.round(s)) || 90 > s && r(a.hour, 1) || 24 > u && r(a.hours, Math.round(u)) || 42 > u && r(a.day, 1) || 30 > m && r(a.days, Math.round(m)) || 45 > m && r(a.month, 1) || 365 > m && r(a.months, Math.round(m / 30)) || 1.5 > d && r(a.year, 1) || r(a.years, Math.round(d)), h = void 0 === a.wordSeparator ? " " : a.wordSeparator;
